...
export function HeroScrub({
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // 0 → 0.15: card scales to 1, titles slide out
      ...
      // 0.15 → 0.78: card immerses, titles fade
      ...
      // 0.78 → 1: card shrinks back, titles return
      ...
      >
        ...
        <div className="relative z-10 flex h-full w-full flex-col items-center justify-center gap-3 md:gap-4">
          <h2
            ...
            style={{ fontSize: "clamp(3.75rem, 12vw, 11rem)", lineHeight: 0.85, letterSpacing: "-0.04em" }}
          >
            {titleTop}
          </h2>
